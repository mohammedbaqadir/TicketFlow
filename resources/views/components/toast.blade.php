...
"
                ...
                >
<span
        class="relative flex flex-col items-start shadow-[0_5px_15px_-3px_rgb(0_0_0_/_0.08)] w-full transition-all duration-300 ease-out bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 sm:rounded-md sm:max-w-xs group"
...
<svg x-show="toast.type=='danger'"
     ...
     xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd"
                                              ...
                                              fill="currentColor"></path></svg>
<p class="text-[13px] font-medium leading-none text-gray-800 dark:text-gray-200" x-text="toast.message"></p>
</div>
<p x-show="toast.description"
   :class="{ 'pl-5' : toast.type!='default' }"
   class="mt-1.5 text-xs leading-none opacity-70 dark:text-gray-300" x-text="toast.description"></p>
</div>
</template>
<template x-if="toast.html">
...
<span
        ...
        class="absolute right-0 p-1.5 mr-2.5 text-gray-400 dark:text-gray-500 duration-100 ease-in-out rounded-full opacity-0 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 hover:text-gray-500 dark:hover:text-gray-400"
...
>
<svg class="w-3 h-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd"

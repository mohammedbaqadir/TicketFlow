<?php
    ...
    return [
        ...
        */
        ...
        'expire_on_close' => Env::get( 'SESSION_EXPIRE_ON_CLOSE', false ),
        ...
        */
        ...
        'table' => Env::get( 'SESSION_TABLE', 'sessions' ),
        ...
        */
        ...
        'cookie' => Env::get(
            'SESSION_COOKIE',
            Str::slug( Env::getOrFail( 'APP_NAME' ), '_' ) . '_session'
        ),
        ...
        */
        ...
        'partitioned' => Env::get( 'SESSION_PARTITIONED_COOKIE', false ),
